...
export const ContactAnimation = ({ email }: ContactAnimationProps) => {
    return (
        <div className="relative overflow-hidden mb-8 md:mb-24 h-[224px] md:h-[400px]">
            <a
                href={`mailto:${email}`}
                title="Send mail"
            ...
            >
                <h4 className="absolute flex items-center text-secondary top-0 left-0 w-full text-center md:top-[5%] md:text-left md:w-auto">
